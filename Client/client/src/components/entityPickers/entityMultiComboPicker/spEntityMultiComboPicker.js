...
(function () {
    ...
    * 
    */
    angular.module('mod.common.ui.spEntityMultiComboPicker', ['mod.common.ui.entityPickerControllers', 'mod.common.ui.spPopupProvider', 'mod.common.ui.spPopupStackManager'])
        .directive('spEntityMultiComboPicker', function (spPopupProvider, $document, spPopupStackManager) {
            return {
                replace: true,
                restrict: 'E',
