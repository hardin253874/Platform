...
(function () {
    ...
    angular.module('app.editFormComponents')
        .component('rnCurrencyKFieldRenderControl', {
            bindings: {
...
<rn-standard-form-control control="$ctrl.control" inline="$ctrl.formOptions.inline" validation-messages="$ctrl.customValidationMessages">
    <sp-currency-control class="rn-control-value" model="$ctrl.model"></sp-currency-control>
</rn-standard-form-control>
`,
            controller: CurrencyKFieldRenderControlController
        });

    function CurrencyKFieldRenderControlController($scope, spFieldControlService) {
        'ngInject';
        ...
        this.$onChanges = changes => {
            // console.log('CurrencyKFieldRenderControlController', _.keys(changes));
