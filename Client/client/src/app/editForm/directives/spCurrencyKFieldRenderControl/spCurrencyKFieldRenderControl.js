...
(function() {
    ...
    /////
    angular.module('mod.app.editForm.designerDirectives.spCurrencyKFieldRenderControl', ['mod.app.editForm', 'mod.app.editForm.spFieldControlProvider', 'mod.common.spCachingCompile', 'mod.common.spMobile'])
