...
(function () {
    ...
    /////
    angular.module('mod.app.editForm.designerDirectives.spCheckboxKFieldRenderControl', ['mod.app.editForm', 'mod.app.editForm.spFieldControlProvider', 'mod.common.spCachingCompile'])
