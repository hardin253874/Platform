...
(function () {
    ...
    /////
    angular.module('mod.app.editForm.designerDirectives.spDecimalKFieldRenderControl', ['mod.app.editForm', 'mod.app.editForm.spFieldControlProvider', 'mod.common.spCachingCompile', 'mod.common.spMobile', 'mod.app.editForm.spDblclickToEdit'])
