...
(defn select-report-row-by-row-column
  ...
  ([rowIndex columnIndex grid-locator]
    (if (is-report-in-inline-edit-mode) (wait-until #(exists-present? (get-row-column-selector rowIndex columnIndex grid-locator)) 5000))
    (click (get-row-column-selector rowIndex columnIndex grid-locator))       
    (if (is-report-in-inline-edit-mode) (wait-until #(does-row-column-have-focus rowIndex columnIndex) 10000)))
  ([rowIndex columnIndex]
