...
namespace ReadiMon.Plugin.Redis
{
	...
	///     Redis message
	/// </summary>
	public class RedisMessage : PubSubMessage<string>
	{
		/// <summary>
		...
		public RedisMessage( string channel, string machine, string process, long processId, string appDomain, long appDomainId, DateTime dateTime, long size, long hostTenantId, string message )
