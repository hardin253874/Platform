...
namespace LogViewer.Common
{
    ...
    /// </summary>
    [ValueConversion(typeof(List<ComparisonOperator>), typeof(List<string>))]
    internal class ComparisonOperatorsListToStringListConverter : IValueConverter
    {
        ...
        public object Convert(object value, Type targetType, object parameter, System.Globalization.CultureInfo culture)
        {
            ...
            List<ComparisonOperator> compOperators = (List<ComparisonOperator>)value;
            foreach (ComparisonOperator compOperator in compOperators)
            {
        ...
        {
            List<ComparisonOperator> convertedValues = new List<ComparisonOperator>();
