...
namespace EDC.Diagnostics
{
    ...
    public static class ProcessMonitorNativeMethods
    {
        ...
        private const int MaxMessageLength = 2047;
        ...
        static ProcessMonitorNativeMethods()
        {
        ...
        public static bool ProcMonDebugOutput(string message, params object[] args)
        {
            ...
            {
                renderedMessage.Append(message);
            }
            else
            {
            ...
            {                
                renderedMessage.Length = MaxMessageLength;
            }
