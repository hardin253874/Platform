...
{
	/// <summary>
	///     A fixed precision and scale numeric value between -10E38 -1 and 10E38 -1.
	/// </summary>
	...
	public class DecimalType : NumericType<Decimal>
	{
		/// <summary>
		...
		public static string SqlDbTypeString
		{
			get
			{
				return "decimal(38,10)"; // precision=38, scale=10 : TODO: review this decision
			}
		}
