...
{
	/// <summary>
	///     Represent a column containing selected levels in a choice relationship.
	...
	public class ChoiceRelationshipType : DatabaseType
	{
		/// <summary>
		...
		public override string ConvertToSqlString( object value )
		{
			...
			//        {
			//            string strValue = value.ToString().Split(':')[1];
			//            text = strValue;
			//        }
			//    }
			//    catch
