...
{
	/// <summary>
	///     Class that created name-based GUIDs as per RFC 4122
	/// </summary>
	public static class GuidUtility
	{
		...
		/// <summary>
		///     The Software Platform Namespace Id.
		/// </summary>
		public static readonly Guid SoftwarePlatformNamespace = new Guid( "{22f9b27b-cb1b-410d-bf8e-d6a689558eb1}" );
