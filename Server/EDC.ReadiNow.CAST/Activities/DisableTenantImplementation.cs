...
{
    /// <summary>
    /// CAST workflow activity that disables a tenant on a remote platform installation.
    /// </summary>
    public class DisableTenantImplementation : CastActivityImplementation<TenantOperationRequest, TenantInfoResponse>
    {
        ...
        {
            get { return "cast:inDisableTenantActivityDatabaseId"; }
        }
        ...
        {
            get { return "cast:exitPointDisableTenantFailure"; }
        }

        /// <summary>
        /// Basic constructor.
        /// </summary>
        public DisableTenantImplementation()
        {
        ...
        internal static string TenantNameArgumentAlias { get { return "cast:inDisableTenantActivityTenantName"; } }

        internal static string TenantArgumentAlias { get { return "cast:outDisableTenantActivityTenant"; } }
