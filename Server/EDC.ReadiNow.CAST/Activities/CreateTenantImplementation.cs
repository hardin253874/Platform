...
{
    /// <summary>
    /// CAST workflow activity that creates a tenant on a remote platform installation.
    /// </summary>
    public class CreateTenantImplementation : CastActivityImplementation<TenantOperationRequest, TenantInfoResponse>
    {
        ...
        {
            get { return "cast:inCreateTenantActivityDatabaseId"; }
        }
        ...
        {
            get { return "cast:exitPointCreateTenantFailure"; }
        }

        /// <summary>
        /// Basic constructor.
        /// </summary>
        public CreateTenantImplementation()
        {
        ...
        internal static string TenantNameArgumentAlias { get { return "cast:inCreateTenantActivityTenantName"; } }

        internal static string TenantArgumentAlias { get { return "cast:outCreateTenantActivityTenant"; } }
