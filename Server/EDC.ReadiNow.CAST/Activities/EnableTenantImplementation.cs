...
{
    /// <summary>
    /// CAST workflow activity that enables a tenant on a remote platform installation.
    /// </summary>
    public class EnableTenantImplementation : CastActivityImplementation<TenantOperationRequest, TenantInfoResponse>
    {
        ...
        {
            get { return "cast:inEnableTenantActivityDatabaseId"; }
        }
        ...
        {
            get { return "cast:exitPointEnableTenantFailure"; }
        }

        /// <summary>
        /// Basic constructor.
        /// </summary>
        public EnableTenantImplementation()
        {
        ...
        internal static string TenantNameArgumentAlias { get { return "cast:inEnableTenantActivityTenantName"; } }

        internal static string TenantArgumentAlias { get { return "cast:outEnableTenantActivityTenant"; } }
