...
{
    /// <summary>
    /// CAST workflow activity that uninstalls an application from a tenant on a remote platform installation.
    /// </summary>
    public class RemoveApplicationImplementation : CastActivityImplementation<ApplicationOperationRequest, ApplicationInfoResponse>
    {
        ...
        /// Basic constructor.
        /// </summary>
        public RemoveApplicationImplementation()
        {
        ...
        {
            get { return "cast:inRemoveApplicationActivityDatabaseId"; }
        }
        ...
        {
            get { return "cast:exitPointRemoveApplicationFailure"; }
        }
        ...
        internal static string ApplicationTenantArgumentAlias { get { return "cast:inRemoveApplicationActivityApplicationTenant"; } }

        internal static string ApplicationIdArgumentAlias { get { return "cast:inRemoveApplicationActivityApplicationId"; } }

        internal static string ApplicationsInstalledArgumentAlias { get { return "cast:outRemoveApplicationApplicationsInstalled"; } }
