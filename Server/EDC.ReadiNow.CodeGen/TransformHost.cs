...
{
	/// <summary>
	///     Transforms the T4 text input.
	/// </summary>
	/// <remarks>
	///     Example taken from MSDN.
	/// </remarks>
	public class TransformHost : ITextTemplatingEngineHost
	{
				...
				return new[]
					{
						...
						typeof ( TransformHost ).Assembly.Location,
				...
				return new[]
					{
						"System",
						"System.Linq",
						"EDC.ReadiNow.Common.ConfigParser",
						"EDC.ReadiNow.Templates"
					};
			}
		}
		...
		public string ResolveAssemblyReference( string assemblyReference )
		{
			...
			{
				string candidate = Path.Combine( directoryName, assemblyReference );
		...
		public string ResolvePath( string fileName )
		{
			...
			if ( directoryName != null )
			{
				string candidate = Path.Combine( directoryName, fileName );
		...
		public void LogErrors( CompilerErrorCollection errors )
		{
			...
			{
				EventLog.WriteError( error.ToString( ), Program.EventLogSource );
			}
		}
