...
namespace ReadiNow.Integration.Sms
{
    ...
    {
        /// <summary>
        /// From https://www.twilio.com/docs/api/errors/reference
        /// </summary>
        readonly static Dictionary<string, string> _errorCodeMap = new Dictionary<string, string>
        {
           {"10001", "Account is not active"},
            ...
            {"50205", "IP Messaging: User unauthorized to set role / Identity should not match user SID pattern / Identity too long"},
        ...
        /// <summary>
        /// Convert an error code string into a message
        /// </summary>
        /// <param name="errorCode"></param>
        /// <returns></returns>
        public static string MessageFromCode(string errorCode)
        {
            ...
            if (!String.IsNullOrWhiteSpace(errorCode))
            {
                ...
                if (!_errorCodeMap.TryGetValue(errorCode, out message))
                {
            ...
            return $"{message} (Twilio Error Code: {errorCode})";
        }
    }
}
