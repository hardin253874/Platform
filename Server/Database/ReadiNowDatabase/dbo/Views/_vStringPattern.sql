...
CREATE VIEW [dbo].[_vStringPattern]
AS
	SELECT
		e.Id,
		r.ToId TypeId,
	...
	OUTER APPLY
		dbo.tblFnFieldNVarCharA( e.Id, e.TenantId, 'regex', 'core' ) f6
	OUTER APPLY
		dbo.tblFnFieldNVarCharA( e.Id, e.TenantId, 'regexDescription', 'core' ) f7