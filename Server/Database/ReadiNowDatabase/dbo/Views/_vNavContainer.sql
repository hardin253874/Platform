...
CREATE VIEW [dbo].[_vNavContainer]
AS
    SELECT
		e.Id,
		r.ToId TypeId,
	...
	OUTER APPLY
		dbo.tblFnFieldNVarCharA( e.Id, e.TenantId, 'chartTitle', 'core' ) f32
	OUTER APPLY
		dbo.tblFnFieldIntA( e.Id, e.TenantId, 'consoleOrder', 'console' ) f33