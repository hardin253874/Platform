...
CREATE VIEW [dbo].[_vDocumentType]
AS
    SELECT
		e.Id,
		r.ToId TypeId,
		...
		f5.Data alias,
		f6.Data shortFileTypeName,
		f7.Data fileTypeDescription,
		f8.Data extension,
		f9.Data mimeType
	FROM (
		SELECT
	...
	OUTER APPLY
		dbo.tblFnFieldNVarCharA( e.Id, e.TenantId, 'shortFileTypeName', 'core' ) f6
	OUTER APPLY
		dbo.tblFnFieldNVarCharA( e.Id, e.TenantId, 'fileTypeDescription', 'core' ) f7
	OUTER APPLY
		dbo.tblFnFieldNVarCharA( e.Id, e.TenantId, 'extension', 'core' ) f8
	OUTER APPLY
		dbo.tblFnFieldNVarCharA( e.Id, e.TenantId, 'mimeType', 'core' ) f9