...
{
    public class EmailServerSettingsEventTarget : IEntityEventSave
    {
        /// <summary>
        /// The SecureId context used for Imap provider
        /// </summary>
        public const string SecureIdContext = "emailServerSettings SmtpPassword";
        ...
        public bool OnBeforeSave(IEnumerable<IEntity> entities, IDictionary<string, object> state)
        {
            ...
            {
                saveHelper.OnBeforeSave(SecureIdContext, TenantEmailSetting.SmtpPassword_Field, TenantEmailSetting.SmtpPasswordSecureId_Field, entity);        
            }
