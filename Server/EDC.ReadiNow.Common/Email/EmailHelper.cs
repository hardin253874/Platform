...
namespace EDC.ReadiNow.Email
{
	...
	public static class EmailHelper
	{
		...
		public static MailMessage CreateMailMessage( 
            string fromAddress, string fromName, IEnumerable<string> toAddresses, string subject, 
		...
		///     A new MailMessage instance.
		/// </returns>
		public static MailMessage CreateMailMessage( string fromAddress, string fromName, IEnumerable<string> toAddresses, IEnumerable<string> ccAddresses, string subject, string body, Dictionary<string, Stream> attachments = null, bool isBodyHtml = false, NameValueCollection headers = null )
		{
			MailMessage mailMessage = CreateMailMessage( fromAddress, fromName, toAddresses, subject, body, attachments, isBodyHtml, headers );
		...
		///     A new MailMessage instance.
		/// </returns>
		public static MailMessage CreateMailMessage( string fromAddress, string fromName, IEnumerable<string> toAddresses, IEnumerable<string> ccAddresses, IEnumerable<string> bccAddresses, string subject, string body, Dictionary<string, Stream> attachments = null, bool isBodyHtml = false, NameValueCollection headers = null )
		{
			MailMessage mailMessage = CreateMailMessage( fromAddress, fromName, toAddresses, ccAddresses, subject, body, attachments, isBodyHtml, headers );
		...
		///     A new MailMessage instance.
		/// </returns>
		public static MailMessage CreateMailMessage( string fromAddress, string fromName, IEnumerable<string> toAddresses, IEnumerable<string> ccAddresses, IEnumerable<string> bccAddresses, IEnumerable<string> replyToAddresses, string subject, string body, Dictionary<string, Stream> attachments = null, bool isBodyHtml = false, NameValueCollection headers = null )
		{
			MailMessage mailMessage = CreateMailMessage( fromAddress, fromName, toAddresses, ccAddresses, bccAddresses, subject, body, attachments, isBodyHtml, headers );
		...
		/// </returns>
		public static void Send(IReadOnlyCollection<MailMessage> messages, string smtpHost )
		{
		...
		///     True if all the messages were sent successfully.
		/// </returns>
		public static void Send(IReadOnlyCollection<MailMessage> messages, string smtpHost, int smtpPort )
		{
		...
		///     True if all the messages were sent successfully.
		/// </returns>
		public static void Send(IReadOnlyCollection<MailMessage> messages, string smtpHost, int smtpPort, bool enableSsl )
		{
		...
		///     True if all the messages were sent successfully.
		/// </returns>
		public static void Send(IReadOnlyCollection<MailMessage> messages, string smtpHost, int smtpPort, bool enableSsl, string username, string password )
		{
		...
		public static void Send(IReadOnlyCollection<MailMessage> messages, string smtpHost, int smtpPort, bool enableSsl, bool useDropDirectory, string username, string password )
		{
		...
		/// </returns>
		public static void SendToDropDirectory(IReadOnlyCollection<MailMessage> messages )
		{
