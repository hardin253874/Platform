...
namespace EDC.ReadiNow.Scheduling.iCalendar
{
	...
	public interface IEvaluator
	{
		...
		/// </summary>
		DateTime EvaluationStartBounds
		{
			get;
		}
		...
		///     </note>
		/// </summary>
		/// <param name="referenceDate">The date to begin evaluation from.</param>
		...
		/// </returns>
		ISet<IPeriod> Evaluate( IDateTime referenceDate, DateTime periodStart, DateTime periodEnd, bool includeReferenceDateInResults );
	}
}