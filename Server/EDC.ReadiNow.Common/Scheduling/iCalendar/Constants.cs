...
namespace EDC.ReadiNow.Scheduling.iCalendar
{
	...
	public enum Methods
	{
		...
		/// Publish.
		/// </summary>
		[EnumDescription( "PUBLISH" )]
		Publish,

		/// <summary>
		/// Request.
		/// </summary>
		[EnumDescription( "REQUEST" )]
		Request,

		/// <summary>
		/// Reply.
		/// </summary>
		[EnumDescription( "REPLY" )]
		Reply,
		...
		/// Cancel.
		/// </summary>
		[EnumDescription( "CANCEL" )]
		Cancel,

		/// <summary>
		/// Refresh.
		/// </summary>
		[EnumDescription( "REFRESH" )]
		Refresh,

		/// <summary>
		/// Counter.
		/// </summary>
		[EnumDescription( "COUNTER" )]
		Counter,

		/// <summary>
		/// Decline-Counter.
		/// </summary>
		[EnumDescription( "DECLINE-COUNTER" )]
		DeclineCount
	}
	...
	public enum ParticipationStatus
	{
		...
		/// Tentative.
		/// </summary>
		[EnumDescription( "TENTATIVE" )]
		Tentative,

		/// <summary>
		/// Delegated.
		/// </summary>
		[EnumDescription( "DELEGATED" )]
		Delegated
	}
	...
	/// <summary>
	///     Recurrence Evaluation Mode Type
	/// </summary>
	...
	{
		public const string Default = "-//SoftwarePlaform.com//NONSGML EDC.ReadiNow.Scheduling.iCalendar 1.0//EN";
	}
